...
# List branches: git -C ./.features/OpenStudioLandscapes-Deadline-10-2-Worker branch -a
# Checkout branch: git -C ./.features/OpenStudioLandscapes-Deadline-10-2-Worker checkout <branch>
```
